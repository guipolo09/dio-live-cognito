# Roteiro para o desenvolvimento da atividade prática do bootcamp da AWS na DIO
...
- Inserir código da função `put_item.js` disponível na pasta `/src` -> Deploy
...
- Domain name -> Domain prefix [diolivetest] -> Save
...
- Auth URL [https://diolivetest.auth.sa-east-1.amazoncognito.com/login]
